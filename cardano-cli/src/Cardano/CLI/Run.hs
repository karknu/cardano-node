...
import           Cardano.CLI.Ping (PingCmdError (..), PingCommand (..), renderPingCmdError,
                   runPingCommand)
...
runClientCommand (CliPingCommand PingCommand) = firstExceptT PingError $ runPingCommand
